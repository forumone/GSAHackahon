...
set :site_url, %w{agilebpa.forumone.com}
...
role :app, %w{agilebpa@prod.forumone.com}, :primary => true
role :web, %w{agilebpa@prod.forumone.com}
role :db,  %w{agilebpa@prod.forumone.com}
