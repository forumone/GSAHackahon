...
angular.module('gsaHackathon').directive(
    ...
    function() {
      ...
      function build(scope, attrs) {
        ...
        // local variables
        var start, size = scope.adjacent * 2, pageCount = Math.ceil(scope.total / scope.pageSize);
      ...
      return {
        ...
        link : function(scope, element, attrs) {
          scope.$watch('page+total', function() {
            if (angular.isDefined(scope.page) && angular.isDefined(scope.total) && angular.isDefined(scope.pageSize)
                && angular.isDefined(scope.total)) {
              build(scope, attrs);
            }
          });
        }
